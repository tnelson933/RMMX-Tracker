...
export default function ReaderSetup() {
  ...
  const [connectorDl, setConnectorDl] = useState({
    macArm:  "https://github.com/tnelson933/RMMX-Tracker/releases/download/connector-v1.0.11/RM-Connect-arm64.dmg",
    macX64:  "https://github.com/tnelson933/RMMX-Tracker/releases/download/connector-v1.0.11/RM-Connect-x64.dmg",
    windows: "https://github.com/tnelson933/RMMX-Tracker/releases/download/connector-v1.0.11/RM-Connect-Setup.exe",
  });
  useEffect(() => {
